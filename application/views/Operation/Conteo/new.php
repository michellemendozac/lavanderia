    ...
    <div class="row">
    	<div class="col-md-6"> 
            ...
            <div class="form-group">
		        <label for="hora_recib">Tipo de servicio:</label>
		        <select class="form-control" placeholder="Tipo de servicio" name="giro"> 			  	 
                    <option value="1"> Lavanderia </option>
                    <option value="2"> Tintoreria </option>		        
                </select>
		    </div>


		    <div class="form-group">
		      <label for="hora_recib"> Unidad:</label>
		      <input type="date" class="form-control" name="hora_recib" value="">
		    </div>

            <div class="form-group">
		      <label for="hora_recib"> Cantidad:</label>
		      <input type="date" class="form-control" name="hora_recib" value="">
		    </div> 


		    <div class="form-group">
		      <label for="promesa_e">Costo de servicio:</label>
		      <input type="time" class="form-control" name="promesa_e" value="">
		    </div>

		    <div class="form-group">
		      <label for="promesa_h">Bultos ropa:</label>
